import random
from custom_types import Chromosome, Individual, Population, Period, H_offset, Magnitude, Negative, V_offset
...
def gen_individual(gait_length: int) -> Individual:
    ...
    for _ in range(12):
        ...
        magnitude: Magnitude = random.uniform(-55, 30)  # Amplitude of joint movement
